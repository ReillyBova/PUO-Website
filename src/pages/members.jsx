...
function Members({ data }) {
    ...
    Object.keys(membersBySection).forEach(
        (section) =>  membersBySection[section].sort(compareByLastName)
    );
                    ...
                    {SECTION_ORDER.map((section) => (
                        <div key={section}>
                            <div className={sectionWrapper}>
                                 ...
                                 {membersBySection[section].map(({suffixedName}) => (
                                     <Typography key={suffixedName} variant="body1">
                                        {suffixedName}
                                    </Typography>
                                ))}
                            </div>
